---
name: weather
description: Live weather widget — looks up current conditions for any city via wttr.in
  (no API key).
version: 0.2.1
type: extension
entry: plugin.py
...
- widget
env_from_settings: []
when_to_use: User asks about weather, temperature, forecast, or current conditions
  in a specific city.
ui_tab:
  tab_id: widget
